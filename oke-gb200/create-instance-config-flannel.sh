...
SUBNET_ID=ocid1.subnet.oc1.ap-sydney-1.aaaaaaaa4lnblajpmftmh3fk2jdvjw6g27qilyfip5td73lnshwijklcu6ua
SUBNET_NSG_ID=ocid1.networksecuritygroup.oc1.ap-sydney-1.aaaaaaaajqv2aoflwe6gbrd5ywshxblt3fgl4mlz2qfbsgeqxsxlg7rjsika
...
oci --region ${REGION} compute-management instance-configuration create --compartment-id ${COMPARTMENT_ID} --display-name gb200-flannel --instance-details \
'{
  ...
  "launchDetails": {
    ...
    "createVnicDetails": {
      ...
      "subnetId": "ocid1.subnet.oc1.ap-sydney-1.aaaaaaaa4lnblajpmftmh3fk2jdvjw6g27qilyfip5td73lnshwijklcu6ua",
      "nsgIds": [ "ocid1.networksecuritygroup.oc1.ap-sydney-1.aaaaaaaajqv2aoflwe6gbrd5ywshxblt3fgl4mlz2qfbsgeqxsxlg7rjsika" ]
    },
    "metadata": {
    ...
    "displayName": "gb200-flannel-instance",
